...
public class A07CharacterTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("여기서부터는 한글 유니 코드 문자 값 테스트");
		char c3 = '가';
		...
		// ///// int 와 char 형식 사이의 자동 캐스팅 /////
		int code3 = c3;					// ** c3은 '가' . 자동 캐스팅하면 44032
		char temp =  (char)code3;		// ** int 를 char 로 캐스팅하면 강제캐스팅
		System.out.println("code3 : " + code3);		//44033
		System.out.println("문자로 캐스팅한 code3 : " + (char)code3);		//int를 char로 강제 캐스팅. '각'
		System.out.println("temp 변수 문자 출력 : " + temp);		//int를 char로 강제 캐스팅. '각'
		...
		c3++;				//44033
		System.out.println("변경된 c3 : " + c3);		//44033
		System.out.println("변경된 c3 문자: " + (int)c3);		//int를 char로 강제 캐스팅. '갂'
