 ...
 * 			ㄴ 인터페이스는 직접 객체를 생성하지 않습니다
 * 			ㄴ 클래스가 인터페이스를 가져다가 규칙을 적용하도록 합니다. => 인터페이스 구현 클래스 
 */ 
public interface InterfaceA {
	//생성자는 없습니다. -> 직접 객체를 생성하지 않습니다.
	//필드는 상수만 가능합니다. public static final (상수) 생략함. 규칙을 정의할 때 필요한 상수값만 선언 
	int SIZE = 100;
	
	
	//인터페이스의 구성 - 아래 4가지만 작성됨. 아래 요소들은 모두 public (모두 오픈됨)
