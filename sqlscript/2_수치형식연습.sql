...
-- 정수 또는 실수 수치 형식
-- 2) 데이터 타입 number  : 자바 정수와 실수 타입 형식 지정  
...
INSERT INTO TBL_NUMBER(xcol,ycol,zcol,zcol2) VALUES (123456789,12345,12345.67,0.00112); -- 오류
...
INSERT INTO tbl_number(zcol) values(12345.678);		-- 예상: 12345.68

SELECT * FROM TBL_NUMBER;


INSERT INTO tbl_number(zcol) values(12345.6);		-- 예상: 12345.6
INSERT INTO tbl_number(zcol) values(12345.678);		-- 예상: 12345.6

-- number 타입은 정수, 실수 모두 저장 가능
INSERT INTO tbl_number(xcol) values(1234);		
INSERT INTO tbl_number(xcol) values(222);		
INSERT INTO tbl_number(xcol) values(222.12312);		
